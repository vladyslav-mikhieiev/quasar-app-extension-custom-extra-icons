 ...
 */
export const defaultNameMapper = (filePath, prefix, options) => {
 ...
 */
export const extract = (filePath, name, options) => {
...
/**
 * Writes the exports to the specified folder.
 *
 * @param {string} iconSetName - The name of the icon set.
 * @param {string} distFolder - The folder to write the exports to.
